...
We call these "**utility terms**" and are covered more in depth in the [standard library section](../../category/stdlib); but is good having in mind that these exists as they make our life much easier while writing a program.
