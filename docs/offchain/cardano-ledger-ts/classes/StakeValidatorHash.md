...
[@harmoniclabs/cardano-ledger-ts](../Introduction.md) / StakeValidatorHash

# Class: StakeValidatorHash
...
### new StakeValidatorHash(bs, className)

> **new StakeValidatorHash**(`bs`, `className`): [`StakeValidatorHash`](StakeValidatorHash.md)
