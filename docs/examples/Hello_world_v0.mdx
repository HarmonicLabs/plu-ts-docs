...
:::caution There is an updated version of this page

[You can find the last version here](./Hello_World).

:::

## Run-trough video

<iframe width="560" height="315" src="https://www.youtube.com/embed/b6MaSz6NIh8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
all the informations about the tranasaction are in the `tx` field of the [`PScriptContext`](../onchain/API/types/V3/ScriptContext/PScriptContext.mdx)
