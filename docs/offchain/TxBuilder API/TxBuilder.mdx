...
[`Provider`](../TxBuilderRunner%20API/providers#provider) to the [`runWithProvider`](./runWithProvider) method
...
If you don't want to take care of querying the data, you can pass a [`Provider`](../TxBuilderRunner%20API/providers#provider)
...
and if some that is missing it will be queried asynchronously using the [`Provider`](../TxBuilderRunner%20API/providers#provider) that was passed.
